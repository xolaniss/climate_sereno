...
#| fig-cap: "Local effects of temperature shocks on sectoral inflation"

plot_a <- baseline_plots$dom_agric_temp_5_95  +
  labs(title = "Panel A: Hot and cold temperature shocks on agriculture") + scale_color_manual(values = pnw_palette("Bay", 2))

plot_b <- baseline_plots$dom_non_agri_temp_5_95 +
  labs(title = "Panel B: Hot and cold temperature shocks on non-agriculture") + scale_color_manual(values = pnw_palette("Bay", 2))

plot_c <- baseline_plots$dom_agric_precip_5_95 +
  labs(title = "Panel C: Wet and dry precipitation shocks on agriculture") + scale_color_manual(values = pnw_palette("Winter", 2))

plot_d <- baseline_plots$dom_non_agri_precip_5_95 +
  labs(title = "Panel D: Wet and dry precipitation shocks on non-agriculture") + scale_color_manual(values = pnw_palette("Winter", 2))
...
#| fig-cap: "Network effects of temperature shocks on sectoral inflation"
...
plot_a <- seasonal_plots$season_winter_temp_5_95 +
  labs(title = "Panel A: Warm and cold temperature shocks in winter") + scale_color_manual(values = pnw_palette("Bay", 2))

plot_b <- seasonal_plots$intercept_temp_5_95 +
  labs(title = "Panel B: Warm and cold temperature shocks in summer") + scale_color_manual(values = pnw_palette("Bay", 2))

plot_c <- seasonal_plots$season_winter_precip_5_95 +
  labs(title = "Panel B: Wet and dry precipitation shocks in winter") + scale_color_manual(values = pnw_palette("Winter", 2))

plot_d <- seasonal_plots$intercept_precip_5_95 +
  labs(title = "Panel D: Wet and dry precipitation shocks in summer") + scale_color_manual(values = pnw_palette("Winter", 2))
...
plot_a <- income_plots$income_classification_temp_dev_5_95 +
  labs(title = "Panel A: Developing countries") + scale_color_manual(values = pnw_palette("Bay", 2))

plot_b <- income_plots$income_classification_temp_eme_5_95 +
  labs(title = "Panel B: Emerging countries") + scale_color_manual(values = pnw_palette("Bay", 2))

plot_c <- income_plots$intercept_temp_5_95 +
  labs(title = "Panel C: Advanced countries") + scale_color_manual(values = pnw_palette("Bay", 2))

plot_d <- income_plots$income_classification_precip_dev_5_95 +
  labs(title = "Panel B: Developing countries") + scale_color_manual(values = pnw_palette("Winter", 2))

plot_e <- income_plots$income_classification_precip_eme_5_95 +
  labs(title = "Panel E: Emerging countries") + scale_color_manual(values = pnw_palette("Winter", 2))

plot_f <- income_plots$intercept_precip_5_95 +
  labs(title = "Panel F: Advanced countries") + scale_color_manual(values = pnw_palette("Winter", 2))
...
plot_a <- inflation_targeting_plots$inflation_targeting_temp_5_95 +
  labs(title = "Panel A: Hot and cold temperature shocks in inflation-targeting countries") + scale_color_manual(values = pnw_palette("Bay", 2))

plot_b <- inflation_targeting_plots$intercept_temp_5_95 +
  labs(title = "Panel A: Hot and cold temperature shocks in non-inflation-targeting countries") + scale_color_manual(values = pnw_palette("Bay", 2))

plot_c <- inflation_targeting_plots$inflation_targeting_precip_5_95 +
  labs(title = "Panel B: Wet and dry precipitation shocks in inflation-targeting countries") + scale_color_manual(values = pnw_palette("Winter", 2))

plot_d <- inflation_targeting_plots$intercept_precip_5_95 +
  labs(title = "Panel D: Wet and dry precipitation shocks in non-inflation-targeting countries") + scale_color_manual(values = pnw_palette("Winter", 2))
...
```{r}
#| label: fig-baseline_temp_10_90
#| fig-cap: "Baseline model: domestic and foreign effects of temperature shocks on sectoral inflation"

effects_plot(model = baseline_plots, 
             dom_agric_var = "dom_agric_temp_10_90",
             dom_non_agric_var = "dom_non_agri_temp_10_90",
             foreign_agric_var = "foreign_agric_temp_10_90",
             foreign_non_agric_var = "foreign_non_agri_temp_10_90"
             )
```

```{r}
#| label: fig-baseline_precip_10_90
#| fig-cap: "Baseline model: domestic and foreign effects of precipitation shocks on sectoral inflation"

effects_plot(model = baseline_plots, 
             dom_agric_var = "dom_agric_precip_10_90",
             dom_non_agric_var = "dom_non_agri_precip_10_90",
             foreign_agric_var = "foreign_agric_precip_10_90",
             foreign_non_agric_var = "foreign_non_agri_precip_10_90"
             )
```

## Baseline results with standardised shocks
```{r}
#| label: fig-baseline_temp_std
#| fig-cap: "Baseline model: domestic and foreign effects of temperature standardised shocks on sectoral inflation"
#| 
baseline_plots_std <- read_rds(here("Outputs", "artifacts_standardised_regs_plots.rds")) |> pluck(1)

effects_plot(model = baseline_plots_std, 
             dom_agric_var = "dom_agric_temp_5_95",
             dom_non_agric_var = "dom_non_agric_temp_5_95",
             foreign_agric_var = "foreign_agric_temp_5_95",
             foreign_non_agric_var = "foreign_non_agric_temp_5_95",
             color = "Sunset" 
             )
```

```{r}
#| label: fig-baseline_precip_std
#| fig-cap: "Baseline model: domestic and foreign effects of precipitation standardised shocks on sectoral inflation"

effects_plot(model = baseline_plots_std, 
             dom_agric_var = "dom_agric_precip_5_95",
             dom_non_agric_var = "dom_non_agric_precip_5_95",
             foreign_agric_var = "foreign_agric_precip_5_95",
             foreign_non_agric_var = "foreign_non_agric_precip_5_95",
             color = "Sunset"
             )
```
