...
climate_summary_tbl <- 
  ...
  mutate(
    variable = 
      case_when(
        variable == "land_weighted_temp_anomaly" ~ "Land-weighted temperature (deviation from mean) (°C)",
        variable == "population_weighted_temp_anomaly" ~ "Population-weighted temperature (deviation from mean) (°C)",
        variable == "land_weighted_precip_anomaly" ~ "Land-weighted precipitation (deviation from mean) (mm)",
        variable == "population_weighted_precip_anomaly" ~ "Population-weighted precipitation (deviation from mean) (mm)"
      )
  )
...
extreme_descriptives_tbl <- 
  ...
  mutate(
    variable = 
      case_when(
        variable == "1" ~ "Land-weighted temperature extreme (90th percentile) (°C)",
        variable == "2" ~ "Land-weighted temperature extreme (10th percentile) (°C)",
        variable == "3" ~ "Land-weighted precipitation extreme (90th percentile) (mm)",
        variable == "4" ~ "Land-weighted precipitation extreme (10th percentile) (mm)",
        
        variable == "5" ~ "Population-weighted temperature extreme (90th percentile) (°C)",
        variable == "6" ~ "Population-weighted temperature extreme (10th percentile) (°C)",
        variable == "7" ~ "Population-weighted precipitation extreme (90th percentile) (mm)",
        variable == "8" ~ "Population-weighted precipitation extreme (10th percentile) (mm)",
        
        variable == "9" ~ "Land-weighted temperature extreme (95th percentile) (°C)",
        variable == "10" ~ "Land-weighted temperature extreme (5th percentile) (°C)",
        variable == "11" ~ "Land-weighted precipitation extreme (95th percentile) (mm)",
        variable == "12" ~ "Land-weighted precipitation extreme (5th percentile) (mm)",

        variable == "13" ~ "Population-weighted temperature extreme (95th percentile) (°C)",
        variable == "14" ~ "Population-weighted temperature extreme (5th percentile) (°C)",
        variable == "15" ~ "Population-weighted precipitation extreme (95th percentile) (mm)",
        variable == "16" ~ "Population-weighted precipitation extreme (5th percentile) (mm)",
        
        variable == "17" ~ "Land-weighted temperature extreme (99th percentile) (°C)",
        variable == "18" ~ "Land-weighted temperature extreme (1st percentile) (°C)",
        variable == "19" ~ "Land-weighted precipitation extreme (99th percentile) (mm)",
        variable == "20" ~ "Land-weighted precipitation extreme (1st percentile) (mm)",
        
        variable == "21" ~ "Population-weighted temperature extreme (99th percentile) (°C)",
        variable == "22" ~ "Population-weighted temperature extreme (1st percentile) (°C)",
        variable == "23" ~ "Population-weighted precipitation extreme (99th percentile) (mm)",
        variable == "24" ~ "Population-weighted precipitation extreme (1st percentile) (mm)"
