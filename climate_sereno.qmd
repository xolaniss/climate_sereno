...
effects_plot <- function(model, 
                         dom_agric_var, 
                         dom_non_agric_var,
                         foreign_agric_var,
                         foreign_non_agric_var,
                         color = "Bay") {
plot_a <- model[[dom_agric_var]] + labs(
  title = "Panel A: Domestic agriculture effect"
) + scale_color_manual(values = pnw_palette(color, 2))
plot_b <- model[[dom_non_agric_var]] + labs(
  title = "Panel B: Domestic non-agriculture effect"
) + scale_color_manual(values = pnw_palette(color, 2))
plot_c <- model[[foreign_agric_var]] + labs(
  title = "Panel C: Foreign agriculture effect"
) + scale_color_manual(values = pnw_palette(color, 2))
plot_d <- model[[foreign_non_agric_var]] + labs(
  title = "Panel D: Foreign non-agriculture effect"
) + scale_color_manual(values = pnw_palette(color, 2))
...
tribble( ~"No.", ~"CPI category", ~"Industry Classification",
          ...
          "10", "Communication", "Information and communication",
          "11", "Hotels", "Accommodation and food service activities"
) |> 
  flextable_word() |> 
...
baseline_plots <- read_rds(here("Outputs", "artifacts_baseline_regs_plots.rds")) |> pluck(1)
seasonal_plots <- read_rds(here("Outputs", "artifacts_hermisphere_reg_plots.rds")) |> pluck(1)
income_plots <- read_rds(here("Outputs", "artifacts_income_classification_plots.rds")) |> pluck(1)
inflation_targeting_plots <- read_rds(here("Outputs", "artifacts_inflation_targeting_plots.rds")) |> pluck(1)

```


## Local effects of abnormal weather on sectoral inflation

```{r}
#| label: fig-baseline_direct
#| fig-cap: "Local effects of weather shocks on sectoral inflation"

plot_details <- function(plot, panel_name, color_scheme = "Bay"){
  plot +
    labs(title = panel_name) +
    scale_color_manual(
      values = pnw_palette(color_scheme, 2),
      labels = c("<5th percentile ", ">95th percentile")
    ) +
    theme(plot.title= element_text(size = 8, face = "bold", hjust = 0.5))
}

plot_a <- baseline_plots$dom_agric_temp_5_95 |>  
  plot_details("Panel A: Hot and cold temperature shocks on agriculture")
plot_b <- baseline_plots$dom_non_agri_temp_5_95 |> 
  plot_details("Panel B: Hot and cold temperature shocks on non-agriculture")
plot_c <- baseline_plots$dom_agric_precip_5_95 |>
  plot_details("Panel C: Wet and dry precipitation shocks on agriculture", "Winter")
plot_d <- baseline_plots$dom_non_agri_precip_5_95 |> 
  plot_details("Panel D: Wet and dry precipitation shocks on non-agriculture", "Winter")

(plot_a + plot_b) / (plot_c + plot_d)
```


## Network effects of weather shocks on sectoral inflation

```{r}
#| label: fig-baseline_network
#| fig-cap: "Network effects of weather shocks on sectoral inflation"


plot_a <- baseline_plots$foreign_agric_temp_5_95 |>  
  plot_details("Panel A: Hot and cold temperature shocks on agriculture")
plot_b <- baseline_plots$foreign_non_agri_temp_5_95 |>
  plot_details("Panel B: Hot and cold temperature shocks on non-agriculture")
plot_c <- baseline_plots$foreign_agric_precip_5_95 |>
  plot_details("Panel C: Wet and dry precipitation shocks on agriculture", "Winter")
plot_d <- baseline_plots$foreign_non_agri_precip_5_95 |>
  plot_details("Panel D: Wet and dry precipitation shocks on non-agriculture", "Winter")
...
## Seasonal effects of weather shocks on sectoral inflation

```{r}
#| label: fig-seasonal_direct 
#| fig-cap: "Local seasonal effects of weather shocks on sectoral inflation"

plot_a <- seasonal_plots$season_winter_temp_5_95 |> 
  plot_details("Panel A: Warm and cold temperature shocks in winter")
plot_b <- seasonal_plots$intercept_temp_5_95 |>
  plot_details("Panel B: Warm and cold temperature shocks in summer")
plot_c <- seasonal_plots$season_winter_precip_5_95 |>
  plot_details("Panel C: Wet and dry precipitation shocks in winter", "Winter")
plot_d <- seasonal_plots$intercept_precip_5_95 |>
  plot_details("Panel D: Wet and dry precipitation shocks in summer", "Winter")

(plot_a + plot_b) / (plot_c + plot_d)
```

## Income level effects of weather shocks on sectoral inflation


```{r}
#| label: fig-income_direct
#| fig-cap: "Income effects of weather shocks on sectoral inflation"
#| fig-height: 8
 
plot_a <- income_plots$income_classification_temp_dev_5_95 |> 
  plot_details("Panel A: Hot and cold temperature shocks in developing countries")
plot_b <- income_plots$income_classification_precip_dev_5_95 |>
  plot_details("Panel B: Wet and dry precipitation shocks in developing countries", "Winter")

plot_c <- income_plots$income_classification_temp_eme_5_95 |>
  plot_details("Panel C: Hot and cold temperature shocks in emerging countries")
plot_d <- income_plots$income_classification_precip_eme_5_95 |>
  plot_details("Panel D: Wet and dry precipitation shocks in emerging countries", "Winter")

plot_e <- income_plots$intercept_temp_5_95 |>
  plot_details("Panel E: Hot and cold temperature shocks in advanced countries")
plot_f <- income_plots$intercept_precip_5_95 |>
  plot_details("Panel F: Wet and dry precipitation shocks in advanced countries", "Winter")

(plot_a + plot_b) / (plot_c + plot_d) / (plot_e + plot_f)
```


## Inflation targeting effects of weather shocks on sectoral inflation

```{r}
#| label: fig-inflation_targeting_direct
#| fig-cap: "Inflation targeting effects of weather shocks on sectoral inflation"

plot_a <- inflation_targeting_plots$inflation_targeting_temp_5_95 |> 
  plot_details("Panel A: Hot and cold temperature shocks in inflation-targeting countries")
plot_b <- inflation_targeting_plots$intercept_temp_5_95 |>
  plot_details("Panel B: Hot and cold temperature shocks in non-inflation-targeting countries")
plot_c <- inflation_targeting_plots$inflation_targeting_precip_5_95 |>
  plot_details("Panel C: Wet and dry precipitation shocks in inflation-targeting countries", "Winter")
plot_d <- inflation_targeting_plots$intercept_precip_5_95 |>
  plot_details("Panel D: Wet and dry precipitation shocks in non-inflation-targeting countries", "Winter")
...
```{r}
#| label: tbl-controls_hemisphere
#| tbl-cap: "Hemisphere classification for weather seasons"
#| ft.arraystretch: 0.4
controls <- read_rds(here("Outputs", "artifacts_controls_prep.rds"))
controls|>   
  pluck(1) |>
  ...
  rename(
    "Country" = country,
    "Hemisphere" = hemisphere_classification ) |> 
  drop_na() |> 
  flextable_word() |>
  align(align = "left", part = "all") |>
  autofit(add_w = 2)
...
\newpage
```{r}
#| label: tbl-controls_income
#| tbl-cap: "Country income level classification"
#| ft.arraystretch: 0.4
...
controls |> 
  ...
  rename(
    "Country" = country,
    "Income level" = income_classification) |>
...
\newpage
```{r}
#| label: tbl-controls_inflation_targeting
#| tbl-cap: "Inflation targeting countries"
#| ft.arraystretch: 0.4
...
\newpage
# Appendix: Alternative results

## Baseline results at 10th and 90th percentiles
```{r}
#| label: fig-baseline_local_10_90
#| fig-cap: "Local effects of temperature shocks on sectoral inflation (10th and 90th percentiles)"

plot_details_10_90 <- function(plot, panel_name, color_scheme = "Bay"){
  plot +
    labs(title = panel_name) +
    scale_color_manual(
      values = pnw_palette(color_scheme, 2),
      labels = c("<10th percentile ", ">90th percentile")
    ) +
    theme(plot.title= element_text(size = 8, face = "bold", hjust = 0.5))
}


plot_a <- baseline_plots$dom_agric_temp_10_90 |>  
  plot_details_10_90("Panel A: Hot and cold temperature shocks on agriculture")
plot_b <- baseline_plots$dom_non_agri_temp_10_90 |> 
  plot_details_10_90("Panel B: Hot and cold temperature shocks on non-agriculture")
plot_c <- baseline_plots$dom_agric_precip_10_90 |>
  plot_details_10_90("Panel C: Wet and dry precipitation shocks on agriculture", "Winter")
plot_d <- baseline_plots$dom_non_agri_precip_10_90 |> 
  plot_details_10_90("Panel D: Wet and dry precipitation shocks on non-agriculture", "Winter")

(plot_a + plot_b) / (plot_c + plot_d)
```

```{r}
#| label: fig-baseline_network_10_90
#| fig-cap: "Network effects of weather shocks on sectoral inflation (10th and 90th percentiles)"

plot_a <- baseline_plots$foreign_agric_temp_10_90 |>  
  plot_details_10_90("Panel A: Hot and cold temperature shocks on agriculture")
plot_b <- baseline_plots$foreign_non_agri_temp_10_90 |>
  plot_details_10_90("Panel B: Hot and cold temperature shocks on non-agriculture")
plot_c <- baseline_plots$foreign_agric_precip_10_90 |>
  plot_details_10_90("Panel C: Wet and dry precipitation shocks on agriculture", "Winter")
plot_d <- baseline_plots$foreign_non_agri_precip_10_90 |>
  plot_details_10_90("Panel D: Wet and dry precipitation shocks on non-agriculture", "Winter")

(plot_a + plot_b) / (plot_c + plot_d)
```

## Baseline results with standardised shocks
```{r}
#| label: fig-baseline_local_std
#| fig-cap: "Local effects of temperature shocks on sectoral inflation (standardised shocks)"

baseline_plots_std <- read_rds(here("Outputs", "artifacts_standardised_regs_plots.rds")) |> pluck(1)

plot_a <- baseline_plots_std$dom_agric_temp_5_95 |>  
  plot_details("Panel A: Hot and cold temperature shocks on agriculture")
plot_b <- baseline_plots_std$dom_non_agric_temp_5_95 |> 
  plot_details("Panel B: Hot and cold temperature shocks on non-agriculture")
plot_c <- baseline_plots_std$dom_agric_precip_5_95 |>
  plot_details("Panel C: Wet and dry precipitation shocks on agriculture", "Winter")
plot_d <- baseline_plots_std$dom_non_agric_precip_5_95 |> 
  plot_details("Panel D: Wet and dry precipitation shocks on non-agriculture", "Winter")
...
```{r}
#| label: fig-baseline_network_std
#| fig-cap: "Network effects of weather shocks on sectoral inflation (standardised shocks)"

plot_a <- baseline_plots_std$foreign_agric_temp_5_95 |>  
  plot_details("Panel A: Hot and cold temperature shocks on agriculture")
plot_b <- baseline_plots_std$foreign_non_agric_temp_5_95 |>
  plot_details("Panel B: Hot and cold temperature shocks on non-agriculture")
plot_c <- baseline_plots_std$foreign_agric_precip_5_95 |>
  plot_details("Panel C: Wet and dry precipitation shocks on agriculture", "Winter")
plot_d <- baseline_plots_std$foreign_non_agric_precip_5_95 |>
  plot_details("Panel D: Wet and dry precipitation shocks on non-agriculture", "Winter")
